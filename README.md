...
- Full AI Analysis (summary, risks, contract terms, technical specs)
- Risk Scoring & Red Flags Detection
- Similar Tenders Discovery (vector similarity)
- Supplier Matching from Samruk - Kazyna Registry
- Analysis Dashboard
...
| AI / Parsing  | LLM-powered Extraction + Embeddings      |
| Database      | Supabase                                 |
